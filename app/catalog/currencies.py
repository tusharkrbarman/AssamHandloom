"""ISO 4217 currency codes and SQL constraints shared by catalogue persistence."""
...
def iso_4217_check(column_name: str) -> str:
    """Return a PostgreSQL CHECK clause that admits only registered currency codes."""

    codes = ", ".join(f"'{code}'" for code in sorted(ISO_4217_CODES))
    return f"{column_name} IN ({codes})"
